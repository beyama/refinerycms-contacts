...
To install, add refinerycms_contacts to your @Gemfile@ and run `bundle install`:

<pre>
gem 'refinerycms_contacts'
</pre>
...
# Check the "GitHub issue tracker":http://github.com/beyama/refinerycms_contacts/issues/ to see if anyone else has reported issue.
